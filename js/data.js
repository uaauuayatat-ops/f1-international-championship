...
const DEFAULT_TEAMS = [
  { id: "redbull",    name: "Red Bull",      color: "#061D42", logo: "assets/teams/redbull.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 2.7 },
  { id: "ferrari",    name: "Ferrari",       color: "#DC0000", logo: "assets/teams/ferrari.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 3.5 },
  { id: "williams",   name: "Williams",      color: "#00A0DE", logo: "assets/teams/williams.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 4.1 },
  { id: "mercedes",   name: "Mercedes",      color: "#00D2BE", logo: "assets/teams/mercedes.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 3.0 },
  { id: "mclaren",    name: "McLaren",       color: "#FF8000", logo: "assets/teams/mclaren.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 25 },
  { id: "audifxr",    name: "Audi FXR",      color: "#BB0A30", logo: "assets/teams/audi.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 10 },
  { id: "porsche",    name: "Porsche",       color: "#D5001C", logo: "assets/teams/porsche.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 14 },
  { id: "racingbulls", name: "Racing Bulls",    color: "#6C98FF", logo: "assets/teams/racingbulls.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 36 },
  { id: "lamborghini",    name: "Lamborghini",      color: "#D8A016", logo: "assets/teams/lamborghini.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 21 },
  { id: "astonmartin",name: "Aston Martin",  color: "#006F62", logo: "assets/teams/astonmartin.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 13 },
  { id: "alpine",     name: "Alpine",        color: "#0090FF", logo: "assets/teams/alpine.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 17 },
  { id: "lotus", name: "Lotus Renault Racing", color: "#C6F300", logo: "assets/teams/lotus.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 23 },
  { id: "bmw",     name: "BMW",        color: "#2B115A", logo: "assets/teams/bmw.png.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 37 },
  { id: "alphatauri", name: "Alpha Tauri", color: "#1634CB", logo: "assets/teams/alphatauri.png.png", points: 0, wins: 0, poles: 0, podiums: 0, odds: 32 },
];
