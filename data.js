...
const DEFAULT_DRIVERS = [
  {
    ...
    age: 27, seasons: 6, bestResult: "1° (Campeón vigente)",
    ...
    career: { wins: 8, podiums: 15, poles: 7, fastLaps: 5, dnf: 1, points: 412 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 2.10, oddsPrev: 2.10, probability: 34, oddsHistory: [2.30, 2.25, 2.15, 2.10],
  ...
  },
  {
    ...
    age: 25, seasons: 4, bestResult: "2°",
    bio: "Cerró la temporada anterior a un gran nivel con Audi FXR: segundo en casi todas las últimas carreras y 5 poles consecutivas. Ahora firma con Mercedes.",
    career: { wins: 5, podiums: 14, poles: 9, fastLaps: 4, dnf: 2, points: 378 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 2.60, oddsPrev: 2.90, probability: 28, oddsHistory: [3.10, 2.95, 2.75, 2.60],
  ...
  },
  {
    ...
    age: 24, seasons: 3, bestResult: "1°",
    bio: "Ganó una carrera durante la temporada, aunque no tuvo un buen cierre con McLaren. Ahora da el salto al mejor auto del grid: Red Bull.",
    career: { wins: 1, podiums: 6, poles: 1, fastLaps: 2, dnf: 4, points: 210 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 3.40, oddsPrev: 4.10, probability: 19, oddsHistory: [4.50, 4.10, 3.70, 3.40],
  ...
  },
  {
    ...
    age: 26, seasons: 4, bestResult: "2°",
    bio: "Excelente temporada con varios podios y un gran cierre de año con Audi FXR. Firma con Ferrari para pelear el título.",
    career: { wins: 2, podiums: 9, poles: 2, fastLaps: 3, dnf: 2, points: 265 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 4.20, oddsPrev: 4.60, probability: 14, oddsHistory: [4.90, 4.70, 4.40, 4.20],
  ...
  },
  {
    ...
    career: { wins: 0, podiums: 3, poles: 0, fastLaps: 1, dnf: 3, points: 150 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 6.50, oddsPrev: 8.00, probability: 9, oddsHistory: [9.00, 8.40, 7.20, 6.50],
    powerRank: 5, powerRankPrev: 7,
  },
  {
    id: "mauricio", name: "Mauricio", number: 75, country: "México", flag: "🇲🇽",
    teamId: "ferrari", status: "confirmado", rumorTeams: [],
    age: 23, seasons: 2, bestResult: "5°",
    bio: "Hizo una temporada regular. Da el salto a Ferrari para la 26/27.",
    career: { wins: 0, podiums: 1, poles: 0, fastLaps: 0, dnf: 5, points: 95 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
  ...
  },
  {
    ...
    teamId: null, status: "rumor", rumorTeams: ["alpine", "mclaren", "mercedes"],
    age: 24, seasons: 3, bestResult: "6°",
    bio: "Piloto libre en el mercado de fichajes. Suenan tres equipos interesados: Alpine, McLaren y Mercedes.",
    career: { wins: 0, podiums: 2, poles: 1, fastLaps: 1, dnf: 3, points: 88 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
  ...
  },
  {
    ...
    teamId: "williams", status: "confirmado", rumorTeams: [],
    age: 26, seasons: 3, bestResult: "7°",
    bio: "Segundo asiento de Williams para la nueva temporada.",
    career: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 4, points: 70 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
  ...
  },
  {
    ...
    age: 25, seasons: 2, bestResult: "8°",
    bio: "Piloto libre a la espera de equipo para la 26/27.",
    career: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 5, points: 55 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
  ...
  {
    id: "maximo", name: "Máximo", number: 33, country: "Por confirmar", flag: "🏳️",
    teamId: null, status: "libre", rumorTeams: [],
    age: 22, seasons: 1, bestResult: "10°",
    bio: "Piloto libre a la espera de equipo para la 26/27.",
  ...
  },
  {
    ...
    teamId: null, status: "libre", rumorTeams: [],
    age: 23, seasons: 1, bestResult: "15°",
    bio: "Piloto libre a la espera de equipo para la 26/27.",
  ...
  {
    id: "chichar", name: "Chichar", number: 47, country: "Perú", flag: "🇵🇪",
    teamId: "mclaren", status: "confirmado", rumorTeams: [],
    age: 22, seasons: 1, bestResult: "16°",
  ...
  { id: "libre6", name: "Piloto libre 6", number: 7, country: "Por confirmar", flag: "🏳️", teamId: "lotusrenault", status: "libre", rumorTeams: [], age: null, seasons: 0, bestResult: "—", bio: "Asiento disponible en Lotus Renault Racing. Piloto a confirmar próximamente.", career: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 }, season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 }, odds: null, oddsPrev: null, probability: null, oddsHistory: [], powerRank: 23, powerRankPrev: 23 },
  { id: "libre7", name: "Piloto libre 7", number: 8, country: "Por confirmar", flag: "🏳️", teamId: "lotusrenault", status: "libre", rumorTeams: [], age: null, seasons: 0, bestResult: "—", bio: "Asiento disponible en Lotus Renault Racing. Piloto a confirmar próximamente.", career: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 }, season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 }, odds: null, oddsPrev: null, probability: null, oddsHistory: [], powerRank: 24, powerRankPrev: 24 },
];
